...
POWER_PLATFORM_ROLE GetPlatformRole() {
  typedef decltype(PowerDeterminePlatformRoleEx)* PowerDeterminePlatformRoleExFunc;
  auto power_determine_platform_role_ex = reinterpret_cast<PowerDeterminePlatformRoleExFunc>(GetProcAddress(
